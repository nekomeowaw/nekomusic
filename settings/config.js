module.exports = {
  ...
  PREFIX: process.env.PREFIX || "f1",
  embed: {
    color: process.env.color || "fcb400",
    wrongcolor: process.env.wrongcolor || "fcb400",
    footertext: "ขอให้คุณสนุกกับการฟังเพลง | By Porsaga,IPAO",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  links: {
    ...
    DiscordServer: process.env.DiscordServer || `https://www.instagram.com/ipao_sk/`,
    VoteURL: process.env.VoteURL || `https://discord.gg/TM8AdnaZyW`,
    VoteURL: process.env.VoteURL || `https://discord.gg/b5Ms9ykT`,
    Website: `https://discord.gg/pNaUpqzGXw`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true,
  ...
  slash: {
    global: true,
    guildID: process.env.GUILD_ID || "1080775912737472532", // for slash command
  },
};
